...
public class TShirt implements Serializable {
    ...
    @NotNull(message = "Price for T-Shirt is required.")
    @DecimalMax(value = "999.99", inclusive = true, message = "Maximum price for the item is above $999.99.")
    @DecimalMin(value = "0.00", inclusive = true, message = "The minimum price for this item is $0.00.")
    private BigDecimal price;
    @NotNull(message = "T-Shirt quantity is required.")
    @Min(value = 1, message = "Minimum quantity is 1.")
    @Max(value = 50000, message = "Maximum quantity allowed is 50,000")
