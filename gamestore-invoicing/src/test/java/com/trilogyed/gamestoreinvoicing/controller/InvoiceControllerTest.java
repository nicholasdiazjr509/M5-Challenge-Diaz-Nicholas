...
public class InvoiceControllerTest {
    ...
    @Autowired//used to move between Objects and JSON
    ...
    public void shouldAddPurchase() throws Exception{
        ...
        when(service.createNewInvoice(inInvoice)).thenReturn(savedInvoice);
    ...
    public void shouldFindInvoice() throws Exception{
        ...
        //Mock call to service layer...
        when(service.getInvoiceById(22)).thenReturn(savedInvoice);
        ...
        //Mock call to service layer...
        when(service.getInvoiceById(-1)).thenReturn(null);
    ...
    public void shouldFindAllInvoices() throws Exception{
        ...
        List<Invoice> foundAllInvoices = new ArrayList<>();
    ...
    public void shouldFailCreateUnvoiceWithBadData() throws Exception{
        Invoice inInvoiceMV = new Invoice();
        inInvoiceMV.setName("");
        ...
        when(this.service.createNewInvoice(inInvoiceMV)).thenReturn(null);
